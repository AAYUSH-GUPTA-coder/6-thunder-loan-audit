    ...
    OracleUpgradeable
{
    ...
    function initialize(address tswapAddress) external initializer {
        ...
        s_feePrecision = 1e18; // @audit-info: Constants should be defined and used instead of literals / magic numbers
        s_flashLoanFee = 3e15; // 0.3% ETH fee @audit-info: Constants should be defined and used instead of literals / magic numbers
    }
    ...
    function flashloan(
        ...
        // @follow up do we need the return value of the functionCall?
    ...
    // @audit-info function could be made external
    ...
    function updateFlashLoanFee(uint256 newFee) external onlyOwner {
        ...
        // @audit-low: This is a storage variable, so it should emit an event
