...
- Found in src/protocol/ThunderLoan.sol [Line: 311](src/protocol/ThunderLoan.sol#L311)

	```solidity
	        uint256 valueOfBorrowedToken = (amount *
	```

- Found in src/protocol/ThunderLoan.sol [Line: 318](src/protocol/ThunderLoan.sol#L318)
...
- Found in src/protocol/ThunderLoan.sol [Line: 333](src/protocol/ThunderLoan.sol#L333)
...
- Found in src/protocol/ThunderLoan.sol [Line: 173](src/protocol/ThunderLoan.sol#L173)
